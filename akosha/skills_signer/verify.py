...
from akosha.skills_signer.errors import UnknownKeyIdError

if TYPE_CHECKING:
    from akosha.skills_signer.manifest import PubkeyManifest, PubkeyManifestEntry
...
def verify_signature(
    ...
    if not isinstance(signature_b64, str):
        raise TypeError(f"signature_b64 must be str, not {type(signature_b64).__name__}")
