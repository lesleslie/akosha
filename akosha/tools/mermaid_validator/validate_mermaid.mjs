...
//
// Designed for the akosha CI guard (test_mermaid_renders.py +
// `akosha docs check-mermaid`). Uses mermaid.parse() — the lexer-only
...
//
// The Python wrapper (akosha.tools.mermaid_validator.renderer) computes both
