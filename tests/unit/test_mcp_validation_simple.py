"""Simple tests for MCP validation module.

Tests request validation and schema validation functionality.
"""
...
class TestEmbeddingValidation:
    ...
    def test_generate_embedding_request_valid(self):
        ...
        request_data = {"text": "Hello world", "batch_size": 32}
...
class TestGraphValidation:
    ...
    def test_find_path_request_invalid_max_hops(self):
        ...
        # max_hops ge=1 so this is actually valid
        result = validate_request(FindPathRequest, **request_data)
...
class TestPerformance:
    ...
    def test_large_text_validation_performance(self):
        ...
        large_text = "a" * 10000  # Large text (max allowed)
