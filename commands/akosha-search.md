...
2. **Searches system memories** — retrieves ranked matches from Akosha's cross-system index.
3. **Summarizes results** — presents the most relevant findings with their source context.
