...
| `architecture` | Architecture documents: ADRs, system-overview docs, architecture reviews, project structure, service-dependency maps (added 2026-07-16 by P7.B for akosha). |
